...
with st.container():
    def add_new_module_func():
        ...
        if new_name:
            ...
            if new_name.casefold() not in (module_name.casefold() for module_name in st.session_state["json_data"]["modules"]):
                ...
                st.session_state["json_data"]["module_to_edit"] = new_name
    ...
    add_new_module = st.text_input(label=" ", label_visibility="collapsed", placeholder="add new module here", on_change=add_new_module_func, key="add_new_module_text")
